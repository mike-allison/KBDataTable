...
(function() {
  ...
  window.KBDataTableViewModel = (function() {
    function KBDataTableViewModel(model) {
      ...
      this.rows = kb.observable(this.model, 'rows');
      ...
      this.nextFn = this.model.get('nextFn');
      this.prevFn = this.model.get('prevFn');
      this.searchFn = this.model.get('searchFn');
      this.sortFn = this.model.get('sortFn');
      this.lastFn = this.model.get('lastFn');
      this.firstFn = this.model.get('firstFn');
      this.selectFn = this.model.get('selectFn');
